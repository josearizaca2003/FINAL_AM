...
class SubCategoriaShowPage extends StatefulWidget {
  final SubCategoriaModel item;

  SubCategoriaShowPage({required this.item});

  @override
  _SubCategoriaShowPageState createState() => _SubCategoriaShowPageState();
}

class _SubCategoriaShowPageState extends State<SubCategoriaShowPage> {
  @override
  void initState() {
    super.initState();
  }
